...
photo20 = Photo.create({title: "Cheepuff from awhile back", description: "photo20 des Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmo", uploader_id: seeduser2.id})

photo21 = Photo.create({title: "Odyssey looks ready for an adventure", description: "photo11 des Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmo", uploader_id: seeduser3.id})
photo22 = Photo.create({title: "I love how Circus photographs", description: "photo12 des Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmo", uploader_id: seeduser3.id})
photo23 = Photo.create({title: "Foster kitten named Socks", description: "photo13 des Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmo", uploader_id: seeduser3.id})
photo24 = Photo.create({title: "Lily looking like her gorgous self", description: "photo14 des Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmo", uploader_id: seeduser3.id})
photo25 = Photo.create({title: "Gary being Gary", description: "photo15 des Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmo", uploader_id: seeduser3.id})
photo26 = Photo.create({title: "Toast on their Adventure", description: "photo16 des Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmo", uploader_id: seeduser4.id})
photo27 = Photo.create({title: "photo of Spot", description: "photo17 des Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmo", uploader_id: seeduser4.id})
photo28 = Photo.create({title: "Fenty spacing out", description: "photo18 des Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmo", uploader_id: seeduser4.id})
photo29 = Photo.create({title: "Chester", description: "photo19 des Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmo", uploader_id: seeduser4.id})
photo30 = Photo.create({title: "Mookie waking up from thier nap", description: "photo10 des Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmo", uploader_id: seeduser2.id})


photo31 = Photo.create({title: "Freckles as a kitten", description: "photo11 des Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmo", uploader_id: seeduser6.id})
photo32 = Photo.create({title: "A kitty I saw yesterday!", description: "photo12 des Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmo", uploader_id: seeduser6.id})
photo33 = Photo.create({title: "Snaps and some leaves", description: "photo13 des Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmo", uploader_id: seeduser6.id})
photo34 = Photo.create({title: "Winter photoshoot with Frosty", description: "photo14 des Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmo", uploader_id: seeduser6.id})
photo35 = Photo.create({title: "Sam the family cat", description: "photo15 des Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmo", uploader_id: seeduser6.id})
photo36 = Photo.create({title: "Fauna before out roadtrip!", description: "photo16 des Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmo", uploader_id: seeduser4.id})
photo37 = Photo.create({title: "ALways a bit worried", description: "photo17 des Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmo", uploader_id: seeduser4.id})
photo38 = Photo.create({title: "Thinking about Cheesecake, also our cat's name", description: "photo18 des Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmo", uploader_id: seeduser4.id})
photo39 = Photo.create({title: "Still worried", description: "photo19 des Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmo", uploader_id: seeduser4.id})

photo40 = Photo.create({title: "Kitty!", description: "photo19 des Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmo", uploader_id: seeduser4.id})
photo41 = Photo.create({title: "It's almost autumn again", description: "photo11 des Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmo", uploader_id: seeduser5.id})
photo42 = Photo.create({title: "Felix", description: "photo12 des Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmo", uploader_id: seeduser5.id})
photo43 = Photo.create({title: "My Fiance's kitten named Snowball", description: "photo13 des Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmo", uploader_id: seeduser5.id})
photo44 = Photo.create({title: "Flora with Floral", description: "photo14 des Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmo", uploader_id: seeduser5.id})
photo45 = Photo.create({title: "Meowsers!", description: "photo15 des Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmo", uploader_id: seeduser5.id})
photo46 = Photo.create({title: "Litten", description: "photo16 des Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmo", uploader_id: seeduser4.id})
photo47 = Photo.create({title: "Litten almost Licking", description: "photo17 des Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmo", uploader_id: seeduser4.id})
photo48 = Photo.create({title: "And pose!", description: "photo18 des Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmo", uploader_id: seeduser5.id})
photo49 = Photo.create({title: "Our foster kitten named Stripes!", description: "photo19 des Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmo", uploader_id: seeduser5.id})

photo50 = Photo.create({title: "Forever loving the blue Blanket", description: "photo19 des Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmo", uploader_id: seeduser5.id})
